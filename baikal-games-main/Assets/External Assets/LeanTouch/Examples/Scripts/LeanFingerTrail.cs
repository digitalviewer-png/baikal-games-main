...
namespace Lean.Touch
{
    ...
    public class LeanFingerTrail : MonoBehaviour
    {
        ...
        [Tooltip("The line prefab")] public LineRenderer LinePrefab;
        ...
        {
            if (MaxLines > 0 && links.Count >= MaxLines) return;
        ...
        private void FingerSet(LeanFinger finger)
        {
            ...
            // Link exists?
            if (link != null && link.Line != null) WritePositions(link.Line, link.Finger);
        }
        ...
        private void FingerUp(LeanFinger finger)
        {
            ...
            if (link != null)
            {
                ...
                if (link.Line != null) Destroy(link.Line.gameObject);
            }
        }
