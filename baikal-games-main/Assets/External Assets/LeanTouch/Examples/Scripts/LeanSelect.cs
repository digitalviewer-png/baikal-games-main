...
namespace Lean.Touch
{
    ...
    public class LeanSelect : MonoBehaviour
    {
        ...
        [Tooltip(
            "This stores the layers we want the raycast/overlap to hit (make sure this GameObject's layer is included!)")]
                ...
                if (CurrentSelectables != null)
                    for (var i = CurrentSelectables.Count - 1; i >= 0; i--)
                    {
                        ...
                        if (currentSelectable != null)
                            ...
                            if (currentSelectable.SelectingFinger != null &&
                                currentSelectable.SelectingFinger.Set == false)
                            {
        ...
        public void SelectScreenPosition(LeanFinger finger, Vector2 screenPosition)
        {
            ...
            switch (SelectUsing)
            {
                ...
                case SelectType.CanvasUI:
                {
                    ...
                    if (results != null && results.Count > 0) component = results[0].gameObject.transform;
                }
                    break;
            }
        ...
        public LeanSelectable FindSelectable(LeanFinger finger)
        {
            for (var i = CurrentSelectables.Count - 1; i >= 0; i--)
            {
                ...
                if (currentSelectable.SelectingFinger == finger) return currentSelectable;
            }
        ...
        public bool IsSelected(LeanSelectable selectable)
        {
            ...
            for (var i = CurrentSelectables.Count - 1; i >= 0; i--)
            {
                ...
                if (currentSelectable == selectable) return true;
            }
            ...
            if (selectable != null && selectable.isActiveAndEnabled)
            {
                if (selectable.HideWithFinger)
                    for (var i = CurrentSelectables.Count - 1; i >= 0; i--)
                    {
                        ...
                        if (currentSelectable.HideWithFinger && currentSelectable.IsSelected) return;
                    }
        ...
        public void DeselectAll()
        {
            ...
            if (CurrentSelectables != null)
            {
                for (var i = CurrentSelectables.Count - 1; i >= 0; i--)
                {
                    ...
                    if (currentSelectable != null) currentSelectable.Deselect();
                }
