...
namespace Lean.Touch
{
    ...
    public class LeanPitchYaw : MonoBehaviour
    {
        ...
        [Tooltip("Pitch of the rotation in degrees")] [Space(10.0f)]
        public float Pitch;
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (PitchClamp) Pitch = Mathf.Clamp(Pitch, PitchMin, PitchMax);

            // Adjust yaw
            Yaw -= drag.x * YawSensitivity * sensitivity;

            if (YawClamp) Yaw = Mathf.Clamp(Yaw, YawMin, YawMax);
