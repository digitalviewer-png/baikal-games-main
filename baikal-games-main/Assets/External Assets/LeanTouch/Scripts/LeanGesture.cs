...
namespace Lean.Touch
{
    ...
    public static class LeanGesture
    {
        ...
        public static bool TryGetWorldDelta(List<LeanFinger> fingers, float distance, ref Vector3 delta,
            Camera camera = null)
        {
            if (fingers != null)
            {
        ...
        public static float GetScreenDistance(List<LeanFinger> fingers)
        {
            ...
            if (TryGetScreenCenter(fingers, ref center)) TryGetScreenDistance(fingers, center, ref distance);
        ...
        public static bool TryGetPinchScale(List<LeanFinger> fingers, Vector2 center, Vector2 lastCenter,
            ref float scale, float wheelSensitivity = 0.0f)
        {
        ...
        public static bool TryGetPinchRatio(List<LeanFinger> fingers, Vector2 center, Vector2 lastCenter,
            ref float ratio, float wheelSensitivity = 0.0f)
        {
            var distance = GetScreenDistance(fingers, center);
            var lastDistance = GetLastScreenDistance(fingers, lastCenter);
        ...
        public static bool TryGetTwistDegrees(List<LeanFinger> fingers, Vector2 center, Vector2 lastCenter,
            ref float degrees)
        {
        ...
        public static bool TryGetTwistRadians(List<LeanFinger> fingers, Vector2 center, Vector2 lastCenter,
            ref float radians)
        {
            if (fingers != null)
            {
