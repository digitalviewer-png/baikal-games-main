...
namespace Lean.Touch
{
    ...
    public class LeanFinger
    {
        ...
        public Ray GetRay(Camera camera = null)
        {
            ...
            if (camera != null) return camera.ScreenPointToRay(ScreenPosition);
        ...
        public Ray GetStartRay(Camera camera = null)
        {
            ...
            if (camera != null) return camera.ScreenPointToRay(StartScreenPosition);
        ...
        public Vector3 GetWorldDelta(float lastDistance, float distance, Camera camera = null)
        {
            ...
            if (camera != null) return GetWorldPosition(distance, camera) - GetLastWorldPosition(lastDistance, camera);
        ...
        public void ClearSnapshots(int count = -1)
        {
            ...
            {
                for (var i = 0; i < count; i++) LeanSnapshot.InactiveSnapshots.Add(Snapshots[i]);
